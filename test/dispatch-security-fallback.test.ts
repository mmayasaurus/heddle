...
`);
  ...
  it('short-circuits class fallback and records a warning when the primary credential file is insecure', async () => {
    ...
    writeFileSync(secretsPath, 'GROQ_API_KEY=synthetic-test-key\n'); // gitleaks:allow — synthetic fixture; secureReadFile rejects the 0o644 mode (next line) before this value is ever read

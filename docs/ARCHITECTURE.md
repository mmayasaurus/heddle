...
the shipped snapshot cannot diverge from the source of truth; mechanical enforcement—rejecting a
dirty tree or a source off main's history—is tracked in HED-507.
